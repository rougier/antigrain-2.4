...
namespace agg
{
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_filter_rgb_nn() {}
        span_image_filter_rgb_nn(const rendering_buffer& src, 
                                 const color_type& back_color,
                                 interpolator_type& inter) :
            base_type(src, back_color, inter, 0) 
        {}
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_filter_rgb_bilinear() {}
        span_image_filter_rgb_bilinear(const rendering_buffer& src, 
                                       const color_type& back_color,
                                       interpolator_type& inter) :
            base_type(src, back_color, inter, 0) 
        {}
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_filter_rgb_2x2() {}
        span_image_filter_rgb_2x2(const rendering_buffer& src, 
                                  const color_type& back_color,
                                  interpolator_type& inter,
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                else
                {
                    ...
                    {
                        fg[0] = fg[1] = fg[2] = src_alpha = image_filter_scale / 2;
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_filter_rgb() {}
        span_image_filter_rgb(const rendering_buffer& src, 
                              const color_type& back_color,
                              interpolator_type& inter,
                              const image_filter_lut& filter) :
            base_type(src, back_color, inter, &filter) 
