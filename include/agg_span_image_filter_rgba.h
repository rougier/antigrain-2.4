...
namespace agg
{
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_filter_rgba_nn() {}
        span_image_filter_rgba_nn(const rendering_buffer& src, 
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_filter_rgba_bilinear() {}
        span_image_filter_rgba_bilinear(const rendering_buffer& src, 
                                        const color_type& back_color,
                                        interpolator_type& inter) :
            base_type(src, back_color, inter, 0) 
        {}
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_filter_rgba_2x2() {}
        span_image_filter_rgba_2x2(const rendering_buffer& src, 
                                   const color_type& back_color,
                                   interpolator_type& inter,
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_filter_rgba() {}
        span_image_filter_rgba(const rendering_buffer& src, 
                               const color_type& back_color,
                               interpolator_type& inter,
                               const image_filter_lut& filter) :
            base_type(src, back_color, inter, &filter) 
