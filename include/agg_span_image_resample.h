...
namespace agg
{
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_resample(const rendering_buffer& src, 
    ...
    public span_image_filter<ColorT, span_interpolator_linear<trans_affine> >
    {
    public:
        typedef ColorT color_type;
        ...
        //--------------------------------------------------------------------
        span_image_resample_affine(const rendering_buffer& src, 
                                   const color_type& back_color,
                                   interpolator_type& inter,
                                   const image_filter_lut& filter) :
            base_type(src, back_color, inter, &filter),
