...
namespace agg
{
    ...
    public:
        ...
        typedef span_image_filter<color_type, interpolator_type> base_type;
        ...
        //--------------------------------------------------------------------
        span_pattern_filter_rgba_nn() : 
            m_wrap_mode_x(1),
            m_wrap_mode_y(1)
        {}

        //--------------------------------------------------------------------
        span_pattern_filter_rgba_nn(const rendering_buffer& src, 
                                    interpolator_type& inter) :
            base_type(src, color_type(0,0,0,0), inter, 0),
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_pattern_filter_rgba_bilinear(const rendering_buffer& src, 
                                          interpolator_type& inter) :
            base_type(src, color_type(0,0,0,0), inter, 0),
            m_wrap_mode_x(src.width()),
            m_wrap_mode_y(src.height())
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_pattern_filter_rgba_2x2(const rendering_buffer& src, 
                                     interpolator_type& inter,
                                     const image_filter_lut& filter) :
            base_type(src, color_type(0,0,0,0), inter, &filter),
            m_wrap_mode_x(src.width()),
            m_wrap_mode_y(src.height())
        {}
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_pattern_filter_rgba(const rendering_buffer& src, 
                                 interpolator_type& inter,
                                 const image_filter_lut& filter) :
            base_type(src, color_type(0,0,0,0), inter, &filter),
            m_wrap_mode_x(src.width()),
