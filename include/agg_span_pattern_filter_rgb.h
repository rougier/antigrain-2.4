...
namespace agg
{
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_pattern_filter_rgb_nn(const rendering_buffer& src, 
                                   interpolator_type& intr) :
            base_type(src, color_type(0,0,0,0), intr, 0),
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_pattern_filter_rgb_bilinear(const rendering_buffer& src, 
                                         interpolator_type& intr) :
            base_type(src, color_type(0,0,0,0), intr, 0),
            m_wrap_mode_x(src.width()),
            m_wrap_mode_y(src.height())
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_pattern_filter_rgb_2x2(const rendering_buffer& src, 
                                    interpolator_type& intr,
                                    const image_filter_lut& filter) :
            base_type(src, color_type(0,0,0,0), intr, &filter),
            m_wrap_mode_x(src.width()),
            m_wrap_mode_y(src.height())
        {}
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_pattern_filter_rgb(const rendering_buffer& src, 
                                interpolator_type& intr,
                                const image_filter_lut& filter) :
            base_type(src, color_type(0,0,0,0), intr, &filter),
            m_wrap_mode_x(src.width()),
