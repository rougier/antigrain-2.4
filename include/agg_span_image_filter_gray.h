...
namespace agg
{
    ...
    template<class ColorT, class Interpolator> 
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_filter_gray_nn() {}
        span_image_filter_gray_nn(const rendering_buffer& src, 
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_filter_gray_bilinear() {}
        span_image_filter_gray_bilinear(const rendering_buffer& src, 
                                        const color_type& back_color,
                                        interpolator_type& inter) :
            base_type(src, back_color, inter, 0) 
        {}
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_filter_gray_2x2() {}
        span_image_filter_gray_2x2(const rendering_buffer& src, 
                                   const color_type& back_color,
                                   interpolator_type& inter,
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_filter_gray() {}
        span_image_filter_gray(const rendering_buffer& src, 
                               const color_type& back_color,
                               interpolator_type& inter,
                               const image_filter_lut& filter) :
            base_type(src, back_color, inter, &filter) 
